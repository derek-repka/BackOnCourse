    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="col-md-5">
                <asp:GridView ID="gveCourses" runat="server" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" AllowSorting="True" DataSourceID="sqldseCourse" AutoGenerateColumns="False" Width="750px">
                    <Columns>
            ...
            <asp:SqlDataSource ID="sqldseCourse" runat="server" ConnectionString="<%$ ConnectionStrings:M418_group3ConnectionString %>" InsertCommand="INSERT INTO platformProduct(firmID, productName, topicID, categoryID, styleID, quantityPerUnit, price, description, discontinued, instructorID) VALUES (@firmID, @productName, @topicID, @categoryID, @styleID, @quantityPerUnit, @price, @description, @discontinued, @instructorID)" SelectCommand="SELECT firmID AS FirmID, productName AS Name, topicID AS TopicID, categoryID AS CategoryID, styleID AS StyleID, quantityPerUnit AS [Quantity/Unit], price AS Price, description AS Description, discontinued AS Discontinued, instructorID FROM platformProduct WHERE (categoryID = 2)" DeleteCommand="DELETE FROM [platformProduct] WHERE [productID] = @productID" UpdateCommand="UPDATE platformProduct SET firmID = @firmID, productName = @productName, topicID = @topicID, categoryID = @categoryID, styleID = @styleID, quantityPerUnit = @quantityPerUnit, price = @price, description = @description, unitsInStock = @unitsInStock, unitsOnOrder = @unitsOnOrder, reorderLevel = @reorderLevel, discontinued = @discontinued WHERE (productID = @productID)">
                <DeleteParameters>
