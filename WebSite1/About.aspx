...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr>
        <p>
            <strong style="font-size: large">Our Story</strong></p>
          <p>
          ...
          <p>
              <strong style="font-size: large">Our Value</strong></p>
          <p>
          ...
          <p>
              <strong style="font-size: large">Our Clients</strong></p>
          <p>
...
&nbsp;&nbsp;&nbsp;
          ...
          <p>
              &nbsp;</p>
          <p>
              <strong style="font-size: large; font-weight: bold">Our People</strong></p>
          <p dir="auto" style="font-weight: bold">
              <asp:Image ID="ProfilePic" runat="server" Height="100px" ImageUrl="~/images/AboutUs/AboutUs_Profile.png" Width="100px" BackColor="#FF8080" />
              &nbsp;&nbsp;&nbsp; Chief Executive Officer</p>
          <p style="font-weight: bold">
              <asp:Image ID="ProfilePic0" runat="server" Height="100px" ImageUrl="~/images/AboutUs/AboutUs_Profile.png" Width="100px" BackColor="#CCCCFF" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Chief Designer Officer</p>
          <p style="font-weight: bold">
              <asp:Image ID="ProfilePic1" runat="server" Height="100px" ImageUrl="~/images/AboutUs/AboutUs_Profile.png" Width="100px" BackColor="#FF9933" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Chief Accounting Officer</p>
          <p style="font-weight: bold">
              <asp:Image ID="ProfilePic2" runat="server" Height="100px" ImageUrl="~/images/AboutUs/AboutUs_Profile.png" Width="100px" BackColor="#339966" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Chief Information Officer</p>
          <p style="font-weight: bold">
              <asp:Image ID="ProfilePic3" runat="server" Height="100px" ImageUrl="~/images/AboutUs/AboutUs_Profile.png" Width="100px" BackColor="#3399FF" />
