      ...
      <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-xs-3">
              &nbsp;<img alt="" src="images/Product.png" style="width: 128px; height: 128px" /></div>

            <div class="col-xs-9">
              <h2 style="margin-top: 0;">  <asp:label ID="ProductName" runat="server" ></asp:label> </h2>
              <h5><strong>Name:</strong> <asp:Label ID="TopicHolder" runat="server" ></asp:Label></h5>
              <h5><asp:Label ID="StyleLabel" runat="server" Text="Style: " style="font-weight: 700"></asp:Label>
            ...
            <div class="text-right">
              <div class="form-inline">
                ...
                <div class="form-group">
                  ...
                  <p>
                      <asp:Label ID="amtRemaining" runat="server" Text="Amount Remaining:" style="font-weight: 700"></asp:Label>
