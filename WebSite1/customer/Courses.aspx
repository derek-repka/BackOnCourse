    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <asp:SqlDataSource ID="eCourseDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:M418_group3ConnectionString %>" SelectCommand="SELECT platformTopic.topicCode AS [Topic Code], platformProduct.productName AS [Instructor Name], platformProduct.price AS Price, platformInstructor.firstName + ' ' + platformInstructor.lastName AS Name, platformOrderLine.quantity AS Quantity FROM platformUser INNER JOIN platformOrder ON platformUser.userID = platformOrder.userID INNER JOIN platformOrderLine ON platformOrder.orderID = platformOrderLine.orderID INNER JOIN platformProduct ON platformOrderLine.productID = platformProduct.productID INNER JOIN platformTopic ON platformProduct.topicID = platformTopic.topicID INNER JOIN platformInstructor ON platformProduct.instructorID = platformInstructor.instructorID WHERE (platformUser.userID = @userID) AND (platformProduct.styleID = 2)">
                <SelectParameters>
